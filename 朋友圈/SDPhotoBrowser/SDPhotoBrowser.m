...
- (void)setupToolbars
{
    if (self.hideTitle == NO) {
        ...
        self.indexLabel.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.5];
...
//    saveButton.backgroundColor = [UIColor colorWithRed:0.1f green:0.1f blue:0.1f alpha:0.90f];
    [saveButton setImage:[UIImage imageNamed:@"icon_ download"] forState:UIControlStateNormal];
